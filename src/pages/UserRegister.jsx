...
const UserRegister = () => {
  ...
  const { backendUrl, emailServiceUrl, setName, setEmail, setPassword } =
  ...
  const onSubmitHandler = async (e) => {
    ...
    try {
      ...
      const { data: otpResponse } = await axios.post(
        emailServiceUrl + "/otp/v1/send",
        {
          email: userEmail,
        },
      );

      if (otpResponse.message === "OTP sent") {
        ...
        <div className="rounded-2xl border border-orange-100 bg-white p-8 shadow-xl">
          ...
          <form onSubmit={onSubmitHandler} className="space-y-5">
            ...
            <button
              ...
              className="flex w-full cursor-pointer items-center justify-center gap-3 rounded-xl border-2 border-slate-200 bg-white px-6 py-3 text-sm font-medium text-slate-700 transition-all duration-200 hover:border-slate-300 hover:bg-slate-50 hover:shadow-md"
            >
          ...
          <div className="mt-6 text-center">
            ...
            <button
              ...
              className="mt-4 cursor-pointer text-sm font-medium text-orange-600 underline underline-offset-2 transition-colors duration-200 hover:text-orange-700"
            >
              Login here
            </button>
          </div>
